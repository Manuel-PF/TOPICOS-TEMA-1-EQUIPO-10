...
/* Definimos los componentes a usar usando variables */
    ...
    public Gui12() {
        ...
        super("Captura Datos");//Titulo del JFrame
        listaAlum = new ListaAlumnos();
        inicio();
        setLayout(null);
        setSize(350, 500);//Dimensiones del JFrame
    ...
    public void inicio() {
        /* Etiqueta sirve para escribir texto, adicionalmente puede para mostrar una imagen*///label
       /*Campo de texto */ //textfield
        ...
        scrollLista.setBounds(10, 180, 300, 100);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == boton1) {
            ...
            eliminar(listaNom.getSelectedIndex());
    ...
    public void añadirAlumno() {
        alum = new Alumno(textfield1.getText(), Byte.parseByte(textfield2.getText()), textfield3.getText(), Byte.parseByte(textfield4.getText()));
        listaAlum.añadir(alum);
        String cad = "\nNombre: "+textfield1.getText() + "\n Edad: " + textfield2.getText() + "\n NCtrl:  " + textfield3.getText() + "\n Semes: " + textfield4.getText();
